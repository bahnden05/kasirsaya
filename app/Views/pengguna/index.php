      ...
      <div class="col-12">
        <div class="card mb-4">
          <div class="card-header pb-0">
            <h6><i class="ni ni-satisfied text-dark align-items-center" aria-hidden="true"></i>&nbsp;Tabel Pengguna</h6>
            ...
            <a class="btn btn-sm bg-gradient-dark text-xxs mb-0" href="<?= base_url() ?>/register"><i class="fas fa-plus"></i>&nbsp;&nbsp;Tambah Pengguna</a>
          </div>
                  ...
                  <?php foreach ($users as $usr) : ?>
                    <tr>
                      ...
                      <td class="text-center">
                        ...
                        &nbsp;&nbsp;&nbsp;
                        <a href="/pengguna/edit/<?= $usr->username; ?>" class="text-primary font-weight-bold text-xs ps-2" data-toggle="tooltip" data-original-title="Edit user"><i class="fas fa-pencil-alt text-primary me-0" aria-hidden="true"></i>
                          Edit
                        </a>
                        &nbsp;&nbsp;&nbsp;

                        <form action="/pengguna/<?= $usr->username; ?>" method="post" class="d-inline">

                          <input type="hidden" name="_method" value="DELETE">

                          <button type="submit" style="border: none; background-color: Transparent;" onclick="return confirm('Hapus data username <?= $usr->username; ?>?');"><a class="text-danger font-weight-bold text-xs ps-2" data-toggle="tooltip" data-original-title="Edit user"><i class="far fa-trash-alt me-0"></i>
                              Hapus
                            </a></button>
                        </form>
                      </td>
