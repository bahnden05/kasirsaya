      ...
      <div class="col-12">
        <div class="card mb-4">
          ...
          <div class="card-body px-0 pt-0">
            <form action="/pengguna/update/<?= $users->id; ?>" method="post">
              <input type="hidden" name="dummy" value="<?= $users['id']; ?>">
              <div class="card-body">
                <div class="form-group">
                  <label>Email</label>
                  <input type="text" class="form-control <?= ($validation->hasError('')) ? 'is-invalid' : ''; ?>" id="Email" name="Email" value="<?= $users['email'] ?>" placeholder="Masukan Nama Pelanggan" required autofocus>
                </div>
                <div class="form-group">
                  <label>Username</label>
                  <input type="text" class="form-control <?= ($validation->hasError('')) ? 'is-invalid' : ''; ?>" id="namaPengguna" name="namaPengguna" autofocus value="<?= $users['username'] ?>">
                </div>
                <!-- card-body -->
                <div class="mb-0 mt-4">
