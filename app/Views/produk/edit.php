      ...
      <div class="col-12">
        <div class="card mb-4">
          <div class="card-header pb-0">
            <h6><i class="ni ni-box-2 text-dark align-items-center" aria-hidden="true"></i>&nbsp;Edit Produk</h6>
          ...
          <div class="card-body px-0 pt-0">
            <form action="/produk/update/<?= $produk['ProdukID']; ?>" method="post">
              <input type="hidden" name="dummy" value="<?= $produk['ProdukID']; ?>">
              <div class="card-body">
                <div class="form-group">
                  <label>Nama Produk</label>
                  <input type="text" class="form-control <?= ($validation->hasError('')) ? 'is-invalid' : ''; ?>" id="namaProduk" name="namaProduk" autofocus value="<?= $produk['nama_produk'] ?>" placeholder="Masukan Nama Produk" required autofocus>
                </div>
                <div class="form-group">
                  <label>Harga Beli</label>
                  <input type="number" class="form-control uang <?= ($validation->hasError('')) ? 'is-invalid' : ''; ?>" id="hargaBeli" name="hargaBeli" autofocus value="<?= $produk['harga_beli'] ?>">
                </div>
                <div class="form-group">
                  <label>Harga Jual</label>
                  <input type="number" class="form-control uang <?= ($validation->hasError('')) ? 'is-invalid' : ''; ?>" id="hargaJual" name="hargaJual" autofocus value="<?= $produk['harga_jual'] ?>">
                </div>
                <div class="form-group">
                  <label>Stock</label>
                  <input type="text" class="form-control <?= ($validation->hasError('')) ? 'is-invalid' : ''; ?>" id="stok" name="stok" autofocus value="<?= $produk['stock'] ?>">
                  <!-- card-body -->
                  <div class="mb-0 mt-4">
