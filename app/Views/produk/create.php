      ...
      <div class="col-12">
        <div class="card mb-4">
          <div class="card-header pb-0">
            <h6><i class="ni ni-box-2 text-dark align-items-center" aria-hidden="true"></i>&nbsp;Tambah Produk</h6>
            ...
            <form action="<?= base_url() ?>/produk/save" method="post">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control <?= ($validation->hasError('nama_produk')) ? 'is-invalid' : ''; ?>" id="namaProduk" name="namaProduk" autofocus value="<?= old('namaProduk') ?>" placeholder="Masukan Nama Produk" required autofocus>
                </div>
                <div class="form-group">
                  <label>Harga Beli</label>
                  <input type="number" class="form-control uang <?= ($validation->hasError('')) ? 'is-invalid' : ''; ?>" id="hargaBeli" name="hargaBeli" autofocus value="<?= old('') ?>" placeholder="Masukkan Harga Beli" autocomplete="off" required>
                </div>
                <div class="form-group">
                  <label>Harga Jual</label>
                  <input type="number" class="form-control uang <?= ($validation->hasError('')) ? 'is-invalid' : ''; ?>" id="hargaJual" name="hargaJual" autofocus value="<?= old('') ?>" placeholder="Masukkan Harga Jual" autocomplete="off" required>
                </div>
                <div class="form-group">
                  <label>Stock</label>
                  <input type="text" class="form-control <?= ($validation->hasError('')) ? 'is-invalid' : ''; ?>" id="stok" name="stok" autofocus value="<?= old('') ?>" placeholder="Masukkan Stock" autocomplete="off" required>
