  ...
  <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur" data-scroll="false">
    <div class="container-fluid py-1 px-3">
      <nav aria-label="breadcrumb">
        ...
        <h6 class="font-weight-bolder text-white mb-0">Edit Pelanggan</h6>
      </nav>
      ...
      <div class="col-12">
        <div class="card mb-4">
          <div class="card-header pb-0">
            <h6><i class="ni ni-single-02 text-dark align-items-center" aria-hidden="true"></i>&nbsp;Edit Pelanggan</h6>
            ...
            <form action="/pelanggan/update/<?= $pelanggan['PelangganID']; ?>" method="post">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control <?= ($validation->hasError('')) ? 'is-invalid' : ''; ?>" id="namaPelanggan" name="namaPelanggan" value="<?= $pelanggan['nama_pelanggan'] ?>" placeholder="Masukan Nama Pelanggan" required autofocus>
                </div>
                <div class="form-group">
                  <label>Alamat</label>
                  <input type="text" class="form-control <?= ($validation->hasError('')) ? 'is-invalid' : ''; ?>" id="Alamat" name="Alamat" autofocus value="<?= $pelanggan['alamat'] ?>">
                </div>
                <div class="form-group">
                  <label>Nomor Telepon</label>
                  <input type="number" class="form-control <?= ($validation->hasError('')) ? 'is-invalid' : ''; ?>" id="noTelepon" name="noTelepon" autofocus value="<?= $pelanggan['nomor_telepon'] ?>">
                </div>
                <!-- card-body -->
                <div class="mb-0 mt-4">
