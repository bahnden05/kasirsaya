      ...
      <div class="col-12">
        <div class="card mb-4">
          <div class="card-header pb-0">
            <h6><i class="ni ni-single-02 text-dark align-items-center" aria-hidden="true"></i>&nbsp;Tabel Pelanggan</h6>
            ...
            <a class="btn btn-sm bg-gradient-dark text-xxs mb-0" href="<?= base_url() ?>/pelanggan/create"><i class="fas fa-plus"></i>&nbsp;&nbsp;Tambah Pelanggan</a>
          </div>
                  ...
                  <?php foreach ($tb_pelanggan as $plg) : ?>
                    <tr>
                      ...
                      <td class="text-center">
                        ...
                        &nbsp;&nbsp;&nbsp;
                        <a href="/pelanggan/edit/<?= $plg['PelangganID']; ?>" class="text-primary font-weight-bold text-xs ps-2" data-toggle="tooltip" data-original-title="Edit user"><i class="fas fa-pencil-alt text-primary me-0" aria-hidden="true"></i>
                          Edit
                        </a>
                        &nbsp;&nbsp;&nbsp;
                        <form action="/pelanggan/<?= $plg['PelangganID']; ?>" method="post" class="d-inline">

                          <input type="hidden" name="_method" value="DELETE">

                          <button type="submit" style="border: none; background-color: Transparent;" onclick="return confirm('Hapus data pelanggan <?= $plg['nama_pelanggan']; ?>?');"><a class="text-danger font-weight-bold text-xs ps-2" data-toggle="tooltip" data-original-title="Edit user"><i class="far fa-trash-alt me-0"></i>
                              Hapus
                            </a></button>
                        </form>
                      </td>
