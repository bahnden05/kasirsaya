...
<body class="">
  ...
  <main class="main-content  mt-0">
    <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg" style="background-image: url('<?= base_url() ?>/assets/img/foto.jpg'); background-position: top;">
      <span class="mask bg-gradient-dark opacity-6"></span>
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            <h1 class="text-white mb-3 mt-0">Selamat Datang!</h1>
    ...
    <div class="container">
      <div class="row mt-lg-n11 mt-md-n10 mt-n10 justify-content-center">
        <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
          <div class="card z-index-0 shadow-lg p-3 mb-5">
            ...
            <div class="card-body">
              <form action="<?= url_to('login') ?>" method="post">
                <div class="mb-3">
                  <input type="text" autocomplete="off" class="form-control <?php if (session('errors.login')) : ?>is-invalid<?php endif ?>" name="login" placeholder="<?= lang('Auth.email') ?>">
            ...
            <!--<div class="form-check form-check-info text-start">
                  ...
                  <label class="form-check-label" for="flexCheckDefault">
                    I agree the <a href="javascript:;" class="text-dark-center font-weight-bolder">Terms and Conditions</a>
                  </label>
                </div>-->
            <div class="text-center">
              <button type="submit" class="btn bg-gradient-dark text-light w-70 my-4 mb-2">
                Sign In
              </button>
              <!-- <p>Belum punya akun?
				<a href="<?= url_to('register') ?>" class="text-dark text-gradient font-weight-bold">Register</a>
			</p> -->
            </div>
            </form>
          </div>
